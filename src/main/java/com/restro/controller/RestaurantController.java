...
public class RestaurantController {
	...
	// TODO: Sort restaurants by given parameter
	@GetMapping("restaurants/sort")
	public List<Restaurant> sortRestaurants(@RequestParam String sortBy) {
	    Sort sort = Sort.by(sortBy);
	    return (List<Restaurant>) restaurantPagingRepository.findAll(sort);
	}
